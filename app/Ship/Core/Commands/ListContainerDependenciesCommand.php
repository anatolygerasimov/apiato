...
use App\Ship\Core\Transformers\ComposerTransformer;
...
class ListContainerDependenciesCommand extends ConsoleCommand
{
    ...
    /**
     * Utility print function that takes an array and outputs it by applying the given indent. Each array found will be
     * printed recursively with indent+indentmodifier.
     *
     * @param     $arr
     * @param int $indent
    ...
    /**
     * Extracts the content of a file  and find all containers by finding all containers in
