...
trait CallableTrait
{
     ...
     *
     * @return mixed
     * @throws UnstorableValueException|ReflectionException
     */
     ...
     * This might be useful for CREATE / UPDATE / DELETE operations
     * in order to prevent the database from corrupt data. Internally,
     * the regular call() method is used!
     *
     * @param       $class
     * @param array $runMethodArguments
     * @param array $extraMethodsToCall
    ...
    private function resolveClass($class)
    {
        ...
        if ($this->needsParsing($class)) {
            ...
            if (config('apiato.logging.log-wrong-apiato-caller-style', true)) {
